...
<html>
  ...
  <body>
    <div class="container-fluid w-100">
      <nav
        class="container mx-auto d-flex my-4 justify-content-between border-bottom border-gray"
      >
        <h3>wajbat</h3>
        <div>
          <button
            type="button"
            class="btn btn-light position-relative custom-btn"
          >
          ...
          <button
            ...
            onclick="location.href='/myorders'"
            style="background-color: #76c095"
          >
            <a href="/myorders" style="text-decoration: none; color: inherit"
              >My orders</a
            >
          </button>
    ...
    <div
      class="container d-flex justify-content-between align-items-center mt-5"
    >
    ...
    <footer class="bg-light py-3">
      <div class="container">
        <div class="d-flex justify-content-between">
          ...
          <p class="text-muted">
            <a href="#">Legal Advice</a> | <a href="#">Privacy Policy</a> |
