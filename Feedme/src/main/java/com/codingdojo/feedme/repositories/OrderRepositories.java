...
public interface OrderRepositories extends CrudRepository<Order,Long> {
	...
	@Query(value = "SELECT count(o.id), o.id, mi.id as item_id, mi.food_name, mi.food_price, o.quantity, o.order_status, o.resturant_id, o.user_id, o.total " +
	"FROM orders o " +
	...
	"GROUP BY o.id, mi.id, mi.food_name, mi.food_price, o.quantity, o.order_status, o.resturant_id, o.user_id, o.total", nativeQuery = true)
